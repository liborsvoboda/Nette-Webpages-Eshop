...
{
    private $appSettingsService, $userRepository, $userId, $formFactory, $translator, $countryRepository;

    public $onDone = [];

    public function __construct(AppSettingsService $appSettingsService, UserRepository $userRepository, FormFactory $formFactory, ITranslator $translator, CountryRepository $countryRepository)
    {
    ...
    public function createComponentForm()
    {
        ...
        $form->addText('iban', 'cart.address.iban')->addConditionOn($form['isCompany'], Form::EQUAL, true);
    ...
    {
        $this->template->render(__DIR__.'/userEdit.latte');
    }

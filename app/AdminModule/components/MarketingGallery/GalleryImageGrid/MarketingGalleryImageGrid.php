...
class MarketingGalleryImageGrid extends Control
{
    ...
    {
        return $this->marketingGalleryRepository->getAll($this->galleryId);
    ...
    public function formSuccess(Form $form)
    {
        ...
        $this->marketingGalleryRepository->add($values, $this->galleryId);
        $this->onDone();
    }

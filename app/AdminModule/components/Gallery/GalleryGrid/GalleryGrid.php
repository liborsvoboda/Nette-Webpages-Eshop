...
class GalleryGrid extends Control
{
    ...
    public function createComponentForm()
    {
        ...
        if($this->galleryId) {
            ...
            $values = $this->galleryRepository->getGalleryById($this->galleryId)->fetch();
    ...
    public function formSuccess(Form $form)
    {
        ...
        if($this->galleryId) {
            $this->galleryRepository->updateGallery($values, $this->galleryId);
        } else {
            $this->galleryRepository->addGallery($values);
        }
        $this->onDone();
    }

...
class CommissionGrid extends Control
{
    ...
    private $gridFactory, $dateFrom, $dateTo, $commissionRepository;
    ...
    {
        return $this->commissionRepository->getAllCommissions($this->dateFrom, $this->dateTo)
            ->select('user_commission.*, CONCAT(user.firstName," ", user.lastName) uname, order.number onumber')->fetchAll();
    }

(function () {
    ...
    map.on('load', function () {
        ...
        var countryCodes = ['AUT', 'DEU', 'CHL', 'FRA', 'ESP', 'PRT', 'GHA', 'LBN', 'KWT', 'SAU', 'BHR', 'JOR', 'IRQ', 'NLD', 'BEL', 'HUN', 'POL', 'RUS', 'BLR', 'UKR', 'EST', 'LVA', 'LTU', 'GRC', 'ITA', 'CYP', 'CHN', 'KOR', 'BGR', 'SVN', 'XKX', 'MNE', 'MDA', 'TWN', 'ALB', 'BIH', 'MLT', 'JPN', 'ROU', 'HRV', 'ARE', 'BHR', 'AUS', 'CHE', 'ITA', 'PRT', 'SWE', 'FIN'];
    ...
    function createDonutChart(props) {
        ...
        var html = '<svg width="' + w + '" height="' + w + '" viewbox="0 0 ' + w + ' ' + w + '" text-anchor="middle" style="font: ' + fontSize + 'px sans-serif">' + '<circle cx="' + r + '" cy="' + r + '" r="' + r0 + '" fill="white" /><text dominant-baseline="central" transform="translate(' + r + ', ' + r + ')">' + props.point_count + '</text></svg>';
